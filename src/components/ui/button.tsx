  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border/70 bg-background/60 hover:bg-background/90 hover:text-foreground backdrop-blur-sm",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent/15 hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero:
          "bg-gradient-to-r from-[hsl(var(--gradient-hero))] to-[hsl(var(--gradient-hero-alt))] text-primary-foreground shadow-[0_18px_45px_rgba(0,0,0,0.45)] hover:shadow-[0_22px_60px_rgba(0,0,0,0.55)]",
        subtle: "bg-card/40 text-foreground border border-border/60 hover:bg-card/70",
      },
      size: {
